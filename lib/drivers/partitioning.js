...
var PartitioningDatabank = function(params) {
    ...
    // Set the max listeners to 2x the number of types in the params
    // (one each for connected and errors) plus a little bit of padding with
    // the default value.

    typeConnected.setMaxListeners((2 * Object.keys(params).length) + 10);
};
